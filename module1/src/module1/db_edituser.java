 ...
 * @author admin
 */
public class db_edituser extends javax.swing.JFrame {

    /**
     * Creates new form db_edituser
     */
    public db_edituser() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(db_edituser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new db_edituser().setVisible(true);
            }
        });
    }
